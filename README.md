...
- The comics on the programmer-art page are numbered 3, 4, 7, 8, 10 and 11 in their source files. The missing numbers were never exported, so the set has gaps nobody but me can see.
