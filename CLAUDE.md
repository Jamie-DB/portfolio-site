...
7. [STYLE] A comic's permalink and title take the line or the moment, not the setting or the character: the vet comic is `/programmer-art/one-more-doc/`, because "vet" reads strangely for an agent (Jamie, Sept 13, 2026).
